...
CM31CSocketServerDlg::CM31CSocketServerDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_M31CSOCKETSERVER_DIALOG, pParent)
{
...
// CM31CSocketServerDlg 메시지 처리기

BOOL CM31CSocketServerDlg::OnInitDialog()
{
...
void CM31CSocketServerDlg::OnPaint()
{
	if (IsIconic())
	{
