...
class CM23ObjectRegion2DDlg : public CDialogEx
{
// 생성입니다.
public:
	CM23ObjectRegion2DDlg(CWnd* pParent = nullptr);	// 표준 생성자입니다.

// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_M23OBJECTREGION2D_DIALOG };
#endif
